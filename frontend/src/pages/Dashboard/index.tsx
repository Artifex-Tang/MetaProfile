...
export default function Dashboard() {
  ...
  const statsCards = [
    { title: '技术画像', value: techStats.data?.total ?? '-',    color: '#1677ff' },
    { title: '项目画像', value: projectStats.data?.total ?? '-', color: '#52c41a' },
    { title: '机构画像', value: orgStats.data?.total ?? '-',     color: '#fa8c16' },
    { title: '人员画像', value: personStats.data?.total ?? '-',  color: '#722ed1' },
  ]
