...
class SearchRequest(_Req):
    ...
    person_domain: list[str] | None = None
...
class SemanticSearchRequest(_Req):
    ...
    person_domain_filter: list[str] | None = None
...
class UpdatePersonProfileRequest(_Req):
    """字段级更新：所有字段可选，仅更新非 None 字段。"""

    person_name_cn: str | None = None
    person_name_en: str | None = None
    ...
    person_advantages: str | None = None
...
class BulkImportRequest(_Req):
    ...
    profiles: list[PersonProfile] = Field(..., min_length=1, max_length=1000)
