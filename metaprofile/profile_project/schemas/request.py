...
class SearchRequest(_Req):
    ...
    project_domain: list[str] | None = None
...
class SemanticSearchRequest(_Req):
    ...
    project_domain_filter: list[str] | None = None
...
class UpdateProjectProfileRequest(_Req):
    """字段级更新：所有字段可选，仅更新非 None 字段。"""

    project_name_cn: str | None = None
    ...
    project_advantages: str | None = None
...
class BulkImportRequest(_Req):
    ...
    profiles: list[ProjectProfile] = Field(..., min_length=1, max_length=1000)
